(function (root, factory) {
  ...
  AsyncInjector.prototype.getWith_84k75t$ = function (T_0, isT, instances_0, continuation_0) {
    return this.getWith_pn9tk4$(getKClass(T_0), instances_0.slice(), continuation_0);
  };
  defineInlineFunction('korinject-js.com.soywiz.korinject.AsyncInjector.getWith_84k75t$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    return function (T_0, isT, instances_0, continuation_0) {
      return this.getWith_pn9tk4$(getKClass(T_0), instances_0.slice(), continuation_0);
    };
  }));
  AsyncInjector.prototype.get_30y1fr$ = function (T_0, isT, continuation_0) {
    return this.get_wx4qjr$(getKClass(T_0), void 0, continuation_0);
  };
  ...
  AsyncInjector.prototype.getOrNull_30y1fr$ = function (T_0, isT, continuation_0) {
    return this.getOrNull_wx4qjr$(getKClass(T_0), void 0, continuation_0);
  };
        ...
        switch (this.state_0) {
          case 0:
            ...
            if (this.local$tmp$_0 == null) {
              this.state_0 = 2;
              this.result_0 = (tmp$ = this.$this.parent) != null ? tmp$.getProviderOrNull_wx4qjr$(this.local$clazz, this.local$ctx, this) : null;
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              break;
            }
          ...
          case 3:
            if (this.local$tmp$_0 == null) {
              this.state_0 = 4;
              this.result_0 = (tmp$_0 = this.$this.nearestFallbackProvider) != null ? tmp$_0(this.local$clazz, this.local$ctx, this) : null;
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              break;
            }
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            tmp$ = this.result_0;
            this.state_0 = 3;
            this.result_0 = tmp$ != null ? tmp$.get_y6n311$(this.$this, this) : null;
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            break;
          case 3:
  ...
  Object.defineProperty(package$korinject, 'KORINJECT_VERSION', {
    get: function () {
      return KORINJECT_VERSION;
    }
  });
  KORINJECT_VERSION = '0.3.1-SNAPSHOT';
